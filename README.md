...
Use [`CITATION.cff`](CITATION.cff). The public repository is <https://github.com/jiajunluo430-creator/multicohort-functional-risk-transportability>, and the clean fixed source release for first submission is [v1.0.1](https://github.com/jiajunluo430-creator/multicohort-functional-risk-transportability/releases/tag/v1.0.1) (commit `9edd908e2fd5985974f225e365e3177cedcea61f`). A DOI may be added through an archival service in a later version.
